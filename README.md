...
[![My Skills](https://skillicons.dev/icons?i=js,ts,java,html,css,cpp,sql,php,cs,react,angular,nodejs,express,tailwind,spring,linux,git,mongodb)](https://skillicons.dev)
